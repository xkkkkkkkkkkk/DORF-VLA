    ...
    def test_formats_sac_update_metrics_with_rlinf_style_names(self):
        ...
        formatted = format_sac_update_metrics(
            {
                "critic_loss": 1.0,
                "critic_td_loss": 0.8,
                "critic_monte_carlo_loss": 0.1,
                "critic_conservative_loss": 0.2,
                "actor_loss": 2.0,
                "alpha_loss": 3.0,
                "alpha": 0.5,
                "entropy": 4.0,
                ...
                "batch_positive_outcome_fraction": 0.75,
                "batch_episode_return_fraction": 0.5,
                "replay_positive_reward_fraction": 0.5,
                "replay_positive_outcome_fraction": 0.6,
                "batch_task_count": 2.0,
        ...
        self.assertEqual(
            formatted,
            {
                ...
                "train/critic/td_loss": 0.8,
                "train/critic/monte_carlo_loss": 0.1,
                "train/critic/conservative_loss": 0.2,
                ...
                "train/batch/positive_outcome_fraction": 0.75,
                "train/batch/episode_return_fraction": 0.5,
                "train/replay_buffer/positive_reward_fraction": 0.5,
                "train/replay_buffer/positive_outcome_fraction": 0.6,
                "train/batch/task_count": 2.0,
