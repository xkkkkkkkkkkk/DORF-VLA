...
class SACFlowTrainerTest(unittest.TestCase):
    def test_config_defaults_match_rlinf_style_values(self):
        ...
        self.assertEqual(cfg.critic_conservative_coef, 0.0)
        self.assertEqual(cfg.critic_monte_carlo_coef, 0.1)
        self.assertEqual(cfg.critic_random_action_strategy, "replay_local_gaussian")
        self.assertEqual(cfg.critic_random_action_std, 0.05)
    ...
    def test_update_sac_runs_critic_actor_alpha_and_target_update(self):
        ...
        self.assertIn("critic_td_loss", metrics)
        self.assertIn("critic_monte_carlo_loss", metrics)
        self.assertIn("critic_conservative_loss", metrics)
        ...
        self.assertIn("replay_positive_reward_fraction", metrics)
