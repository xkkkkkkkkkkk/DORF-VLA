...
_SAC_METRIC_NAMES = {
    ...
    "critic_td_loss": "train/critic/td_loss",
    "critic_monte_carlo_loss": "train/critic/monte_carlo_loss",
    "critic_conservative_loss": "train/critic/conservative_loss",
    "critic_pairwise_loss": "train/critic/pairwise_loss",
    "critic_pair_count": "train/critic/pair_count",
    ...
    "batch_positive_outcome_fraction": "train/batch/positive_outcome_fraction",
    "batch_episode_return_fraction": "train/batch/episode_return_fraction",
    "batch_task_count": "train/batch/task_count",
    "replay_positive_reward_fraction": "train/replay_buffer/positive_reward_fraction",
    "replay_positive_outcome_fraction": "train/replay_buffer/positive_outcome_fraction",
    "batch_intervention_fraction": "train/batch/intervention_fraction",
    "replay_intervention_fraction": "train/replay_buffer/intervention_fraction",
    "batch_intervention_labeled_fraction": "train/batch/intervention_labeled_fraction",
    "replay_intervention_labeled_fraction": "train/replay_buffer/intervention_labeled_fraction",
